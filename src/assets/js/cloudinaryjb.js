...
(function() {
  ...
  var audi = cl.imageTag('convoicar_website/audi_s5wkiy', {effect: "colorize", color: "#006674", height: 50, quality: 100, crop: "scale", format: "png"}).toHtml();
  var firststop = cl.imageTag('convoicar_website/firststop_uku9rt', {effect: "colorize", color: "#006674", height: 40, quality: 100, crop: "scale", format: "png"}).toHtml();
  var topgarage = cl.imageTag('convoicar_website/topgarage_j5vofs', {effect: "colorize", color: "#5BA3AC", height: 50, quality: 100, crop: "scale", format: "png"}).toHtml();
